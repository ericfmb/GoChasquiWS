...
namespace gochasqui
{
    public class rol
    {
        ...
        public rol(int Id_rol, string Nombre, bool Activo)
        {
            _id_rol = Id_rol;
            _nombre = Nombre;
            _activo = Activo;
        ...
        {
            DbCommand cmd = db1.GetStoredProcCommand("lista_rol_todos");
        ...
        private void RecuperarDatos()
        {
            try
            {
                DbCommand cmd = db1.GetStoredProcCommand("lista_rol_individual");
        ...
        public string ABM(int context_id_usuario)
        {
            ...
            try
            {
                DbCommand cmd = db1.GetStoredProcCommand("abm_rol");
                db1.AddInParameter(cmd, "id_rol", DbType.Int32, _id_rol);
                ...
                db1.AddOutParameter(cmd, "id_rol_aux", DbType.Int32, 32);
                ...
                _id_rol = (int)db1.GetParameterValue(cmd, "id_rol_aux");
