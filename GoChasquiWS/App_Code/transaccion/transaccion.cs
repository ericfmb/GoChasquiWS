...
namespace gochasqui
{
    public class transaccion
    {
        ...
        public transaccion(int Id_transaccion, decimal Monto, decimal Monto_facturado, DateTime Fecha, DateTime Fecha_pago, int Id_pedido, bool Anulado, DateTime Fecha_anulado)
        {
            _id_transaccion = Id_transaccion;
            _monto = Monto;
        ...
        {
            DbCommand cmd = db1.GetStoredProcCommand("lista_transaccion_todos");
        ...
        private void RecuperarDatos()
        {
            try
            {
                DbCommand cmd = db1.GetStoredProcCommand("lista_transaccion_individual");
        ...
        public string ABM(int context_id_usuario)
        {
            ...
            try
            {
                DbCommand cmd = db1.GetStoredProcCommand("abm_transaccion");
                db1.AddInParameter(cmd, "id_transaccion", DbType.Int32, _id_transaccion);
                ...
                db1.AddOutParameter(cmd, "id_transaccion_aux", DbType.Int32, 32);
                ...
                _id_transaccion = (int)db1.GetParameterValue(cmd, "id_transaccion_aux");
